                ...
                {state.routes.map((route, index) => {
                    ...
                    const onPress = () => {
                        ...
                        if (route.name == SCREEN.HOME) {
                            a = 0;
                        } else if (route.name == SCREEN.LIKES) {
                            a = (SIZES.width) / 5;
                        } else if (route.name == SCREEN.MEDIA) {
                            a = (SIZES.width) / 5 * 2;
                        ...
                        <View style={styles.tabItem} key={index}>
                            ...
                            >
                                <Image
                                    ...
                                    source={
                                        label === SCREEN.HOME ? IMAGES.home :
                                            label === SCREEN.LIKES ? IMAGES.heart :
                                                label === SCREEN.MEDIA ? IMAGES.reel :
                                                    label === SCREEN.CHAT ? IMAGES.chat :
                                                        label === SCREEN.PROFILE && IMAGES.user
                                    }
                                />
                            </TouchableOpacity>
                        </View>
