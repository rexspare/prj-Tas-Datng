...
const ProfileSheet = ({ visible, setVisible }) => {
    const { t } = useLanguage()
    ...
    const [gradientColors, setGradientColors] = useState(userData?.profileColors || defaultBorders)

    const onSelectColor = ({ rgb }) => {
        setGradientColors((prevColors) => {
            const updatedColors = [...prevColors]
            updatedColors[activeTab] = rgb
            return updatedColors
        })
    }

    const handleSave = async () => {
        await updateUser({ profileColors: gradientColors })
        onClose()
    }
            ...
            <View style={Styles.modal}>
                ...
                <View style={Styles.modalContainer}>
                    ...
                    <View style={Styles.headerStyle}>
                        <Text style={Styles.title}>{t('customizeProfilePic')}</Text>
